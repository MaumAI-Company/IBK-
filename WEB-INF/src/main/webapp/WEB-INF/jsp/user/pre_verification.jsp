            ...
            <div class="result_detail">
                <table summary="분류, paper로 구성">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td id="msg_detail_context" style="white-space:pre;" colspan="2" class="lyr_con"> <!-- 2023-04-17(Mon) style="white-space:pre;" 추가 -->
...
function msgOpen(id){
    ...
    // 2023-03-22(수) original comment - var context = $('#msgContext_'+ id).val();
    //var context = $('#msgContext_'+ id).val().replace(/(?:\r\n|\r|\n)/g, '<br />');
    // 2023-04-17(월) 문자 치환 처리
    var context = $('#msgContext_'+ id).val();
        context = context.replace(/&/g, '&amp;')
    			         .replace(/>/g, '&gt;')
    			         .replace(/</g, '&lt;')
   				         .replace(/"/g, '&quot;');
    	//2023-03-03 개행(줄바꿈) 추가 start
	    //context = context.replaceAll(/(\n|\r\n)/g, "<br>");
	    //2023-03-03 개행(줄바꿈) 추가 end

        //2023-03-05 개행(줄바꿈) 추가 start
	  //context = context.replace(/\r/g, "").split(/\n/);
	    //2023-03-05 개행(줄바꿈) 추가 end
