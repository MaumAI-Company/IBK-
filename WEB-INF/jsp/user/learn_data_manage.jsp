                ...
                <table summary="">
                     ...
                     <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                             <th rowspan="2">Rearning Rate</th>
                             <td>
                                <input id="learningRate" name="learningRate" type="text" class="ipt_txt" placeholder="0.00001 (default)" onkeypress="return isNumberKey(event);" onkeyup="this.value=this.value.replace(/[\ㄱ-ㅎㅏ-ㅣ가-힣]/g, '');">
                            </td>
                         </tr>
                          <tr>
...
function isNumberKey(evt) {
	...
	*/
    ...
    // 소수점 다섯째자리까지만 입력가능
    var _pattern2 = /^\d*[.]\d{5}$/; // 현재 value값이 소수점 둘째짜리 숫자이면 더이상 입력 불가
