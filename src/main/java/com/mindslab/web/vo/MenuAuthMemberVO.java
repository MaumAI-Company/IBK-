...
@Getter
@Setter
public class MenuAuthMemberVO extends PageDTO implements Serializable{
    ...
    private String memFailCnt; // '비밀번호실패횟수'
    ...
    private String searchAuthType = "all"; // 검색사용자 권한
    private String searchCriteria = "all"; // 조회조건 권한
