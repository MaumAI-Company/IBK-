...
<%!
     ...
     *  Web-Agent 환경 설정   (** 수정)
     ************************************************************/
/**/private static final String AUTH_URL = "http://nsso.ibk.co.kr";     // ISign+ SSO URL | 개발: http://nsso-dev.ibk.co.kr:80, 운영: http://nsso.ibk.co.kr:80
/**/private static final String agentId = "211";                     	// 업무 시스템 고유 번호(관리자가 할당한 번호) | 개발: 211/ 운영: 211
/**/private static final String requestData = "id,empid";       // 요청 데이터(세션에 저장될 값)
