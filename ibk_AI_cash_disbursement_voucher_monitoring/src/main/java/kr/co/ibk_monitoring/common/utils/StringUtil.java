...
public class StringUtil {
	...
	*/
	...
	public static String getReSize(String contents, int length) throws Exception {
		return getReSize(contents, length, ".");
	}
	
	public static String getReSize(String contents, int length, String tail) throws Exception {

		if (contents != null && contents.length() > length) {
			contents = contents.substring(0, length) + String.format("%s%s%s", tail, tail, tail);
		}
    ...
    /**
     * <PRE>
     * 1. MethodName 	: setNulltoZero
     * 2. ClassName  	: StringUtil
     * 3. Comment   	: Null이면 0을 리턴
     * 4. 작성자    	: 박재현
     * 5. 작성일    	: 2017.12.226. 오후 5:23:40
     * </PRE>
     *   @return String
     ...
     *   @return
     */
    public static String setNulltoZero(String num) {
