...
public class PageMaker {
    ...
    private int totalPages;     // 게시판 전체 페이지 개수
    private int displayPageNum;   // 게시판 화면에서 한번에 보여질 페이지 번호의 개수 ( 1,2,3,4,5,6,7,9,10)
    ...
    public void setTotalCount(long totalCount, int displayPageNum) {
        this.totalCount = totalCount;
    ...
    private void calcData() {
        ...
        totalPages = (int)Math.ceil(totalCount/(double) displayPageNum);
    }
